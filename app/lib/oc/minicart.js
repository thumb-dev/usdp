...
function minicart() {
    ...
    function template(){
        return [
            '<style>',
            '.minicart { padding: 25px 15px 15px 0; float: right; cursor: pointer;color: white; min-width:300px; text-align:right;font-size:14px;}',
            ...
            '.minicart .label.label-default {border-radius: 50%;;background-color: #3B3E41;}',
            ...
            '</style>',
            '<div ng-show="currentOrder && cartCount && !isInPath(\'order/\')" style="height:10px;">',
            '    <div class="minicart">',
            '        <i class="fa fa-shopping-cart"></i> <span class="label label-default" style="background:#67cce9;">{{cartCount}}</span> <span class="hidden-xs" style="font-weight: bold;"> - {{currentOrder.Total | currency }}</span> <i class="fa fa-caret-down text-muted" style="color:white;"></i>',
            ...
            '            <div class="row">',
            '                <div class="col-xs-6">',
            '                    <a class="btn btn-default btn-block minicart-btn" href="cart">View Cart</a>',
            '                </div>',
            '                <div class="col-xs-6">',
            '                    <a class="btn btn-default btn-block minicart-btn" ng-click="cartCheckOut()">Checkout</a>',
            '                </div>',
            '            </div>',
            '        </div>',
            '    </div>',
